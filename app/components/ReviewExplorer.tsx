    ...
    <div className="flex flex-col h-full space-y-6">
      ...
      <div className="glass-panel rounded-2xl sm:rounded-3xl p-4 sm:p-5 border border-slate-200 space-y-4">
        ...
        <form onSubmit={handleSearch} className="flex gap-2">
          ...
          <button
            type="submit"
            className="px-6 py-2.5 rounded-xl text-xs font-bold bg-indigo-600 text-white hover:bg-indigo-700 transition-all cursor-pointer shadow-xs"
          >
            Search
          </button>
        </form>
            ...
            <div className="flex flex-wrap gap-1.5">
              {[
                ...
                <button
                  ...
                  className={`px-2.5 py-1 rounded-xl text-xs font-semibold border transition-all cursor-pointer ${
                    sentiment === s.id
                      ? s.color || "bg-indigo-600 text-white border-indigo-600"
                      : "bg-slate-100 border-slate-200 text-slate-700 hover:bg-slate-200"
                  }`}
